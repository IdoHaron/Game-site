let game;_db3‍.w("./game-modules/game-objects.js",[["default",["game"],function(v){game=v}]]);const http = require("http");
...
io.on('connection', (socket) => {
    ...
    socket.on("RPS", (Select_RPS, index, game) => {
        ...
        _db3‍.g.console.log(backgammon_games[game].user2.Select_RPS);
        _db3‍.g.console.log(backgammon_games[game].user1.Select_RPS);
    ...
    socket.on("load-turns", (game_index) => {
        _db3‍.g.console.log("" + backgammon_games[game_index].user_turn);
...
function updtae_server_board(current, game_index, user) {
    current.eat = [];
    _db3‍.g.console.log("game-index: " + game_index);
    for (let i = 1; current[`soldier${i}`] !== undefined; i++) {
        ...
        if (backgammon_games[game_index].board[current[`soldier${i}`].new] === 0) {
            _db3‍.g.console.log("gets here: Side: " + current.side);
            _db3‍.g.console.log(current);
            backgammon_games[game_index].board[current[`soldier${i}`].new] += current.side;
            current.eat.push({
